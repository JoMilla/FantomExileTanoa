class HALV_painshop_dialog
{
	...
	class controls
	{
		...
		class HALV_paintshop_mainswitch: HALV_RscCheckbox
		{
			...
			tooltip = "Click to switch between texture list and colour sliders";
		};
		...
		class HALV_paintshop_mainbutacc: HALV_RscButton
		{
			...
			tooltip = "Accept all colors / Textures on the list";
		};
		...
		class HALV_paintshop_mainbutadd: HALV_RscButton
		{
			...
			tooltip = "Add Current Selected Color / Texture to the list";
		};
		...
		class HALV_paintshop_slider1: HALV_RscSlider
		{
			...
			tooltip = "Slide to increase / decrease red color";
		};
		class HALV_paintshop_slider2: HALV_RscSlider
		{
			...
			coloractive[] = { 0, 1, 0, 1 };
			onSliderPosChanged = "_this call HALV_paintshop_slidingcolor;false";
			tooltip = "Slide to increase / decrease green color";
		};
		class HALV_paintshop_slider3: HALV_RscSlider
		{
			...
			coloractive[] = { 0, 0, 1, 1 };
			onSliderPosChanged = "_this call HALV_paintshop_slidingcolor;false";
			tooltip = "Slide to increase / decrease blue color";
		};
		class HALV_paintshop_slider4: HALV_RscSlider
		{
			...
			coloractive[] = { 1, 1, 1, 1 };
			onSliderPosChanged = "_this call HALV_paintshop_slidingcolor;false";
			tooltip = "Slide to increase / decrease saturation";
		};
	};
};