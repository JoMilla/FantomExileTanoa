...
_cantBuildNear = [
    //Military and NO Nos
                "Land_SCF_01_storageBin_big_F","Land_SCF_01_boilerBuilding_F","Land_BasaltWall01_gate_F","Land_i_Barracks_V2_F","Land_u_Barracks_V2_F","Land_Cargo_House_V1_F","Land_Cargo_House_V3_F","Land_Cargo_HQ_V1_F",
 ...
 try
 {
  ...
  if ([player, _minimumDistanceToSpawnZones] call ExileClient_util_world_isSpawnZoneInRange) then
  {
   throw "You are too close to a spawn zone.";
        ...
        {
         throw "You cannot build within 200m of Industrial buildings!";
        };
