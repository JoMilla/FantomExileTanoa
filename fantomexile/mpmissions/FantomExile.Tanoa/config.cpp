...
class CfgExileArsenal
{
	...
	class U_OrestesBody 							{ quality = 1; price = 50; };
	class U_Rangemaster 							{ quality = 1; price = 50; };
	class U_NikosAgedBody 							{ quality = 1; price = 50; };
	class U_NikosBody 								{ quality = 1; price = 50; };
	class U_Competitor 								{ quality = 1; price = 50; };

	///////////////////////////////////////////////////////////////////////////////
	// Soldier Uniforms
	///////////////////////////////////////////////////////////////////////////////
	class U_B_CombatUniform_mcam 					{ quality = 2; price = 200; };
	class U_B_CombatUniform_mcam_tshirt 			{ quality = 2; price = 200; };
	class U_B_CombatUniform_mcam_vest 				{ quality = 2; price = 200; };
	class U_B_CombatUniform_mcam_worn 				{ quality = 2; price = 200; };
	class U_B_CTRG_1 								{ quality = 2; price = 200; };
	class U_B_CTRG_2 								{ quality = 2; price = 200; };
	class U_B_CTRG_3								{ quality = 2; price = 200; };
	class U_I_CombatUniform 						{ quality = 1; price = 200; };
	class U_I_CombatUniform_shortsleeve				{ quality = 1; price = 200; };
	class U_I_CombatUniform_tshirt					{ quality = 1; price = 200; };
	class U_I_OfficerUniform						{ quality = 1; price = 250; };
	...
	class U_I_G_Story_Protagonist_F 				{ quality = 3; price = 200; };
	class Exile_Uniform_Woodland 					{ quality = 3; price = 200; };

	///////////////////////////////////////////////////////////////////////////////
	// Guerilla Uniforms
	///////////////////////////////////////////////////////////////////////////////
	class U_C_HunterBody_grn						{ quality = 1; price = 200; };
	class U_IG_Guerilla1_1							{ quality = 1; price = 200; };
	class U_IG_Guerilla2_1							{ quality = 1; price = 200; };
	class U_IG_Guerilla2_2							{ quality = 1; price = 200; };
	class U_IG_Guerilla2_3							{ quality = 1; price = 200; };
	class U_IG_Guerilla3_1							{ quality = 1; price = 200; };
	class U_BG_Guerilla2_1							{ quality = 1; price = 200; };
	class U_IG_Guerilla3_2							{ quality = 1; price = 200; };
	class U_BG_Guerrilla_6_1						{ quality = 2; price = 250; };
	class U_BG_Guerilla1_1							{ quality = 1; price = 200; };
	class U_BG_Guerilla2_2							{ quality = 1; price = 200; };
	class U_BG_Guerilla2_3							{ quality = 1; price = 200; };
	class U_BG_Guerilla3_1							{ quality = 1; price = 200; };
	class U_BG_leader								{ quality = 3; price = 200; };
	class U_IG_leader								{ quality = 3; price = 200; };
	class U_I_G_resistanceLeader_F					{ quality = 3; price = 250; };
	...
	class U_B_GhillieSuit							{ quality = 2; price = 600; };
	...
	class U_O_GhillieSuit							{ quality = 2; price = 600; };

	///////////////////////////////////////////////////////////////////////////////
	// Wet Suits
	///////////////////////////////////////////////////////////////////////////////
	class U_I_Wetsuit								{ quality = 3; price = 100; };
	class U_O_Wetsuit								{ quality = 3; price = 100; };
	class U_B_Wetsuit								{ quality = 3; price = 100; };
	class U_B_survival_uniform						{ quality = 3; price = 100; };
	...
	// Chestrigs
	///////////////////////////////////////////////////////////////////////////////
	class V_Chestrig_blk 							{ quality = 1; price = 100; };
	class V_Chestrig_khk 							{ quality = 1; price = 100; };
	class V_Chestrig_oli 							{ quality = 1; price = 100; };
	class V_Chestrig_rgr 							{ quality = 1; price = 100; };
	...
	class V_HarnessOGL_brn							{ quality = 1; price = 150; };
	class V_HarnessOGL_gry							{ quality = 1; price = 150; };
	...
	// Plate Carriers
	///////////////////////////////////////////////////////////////////////////////
	class V_PlateCarrier1_blk 						{ quality = 1; price = 400; };
	class V_PlateCarrier1_rgr 						{ quality = 1; price = 400; };
	class V_PlateCarrier2_rgr 						{ quality = 2; price = 500; };
	class V_PlateCarrier3_rgr 						{ quality = 2; price = 500; };
	class V_PlateCarrierGL_blk 						{ quality = 3; price = 600; };
	class V_PlateCarrierGL_mtp 						{ quality = 3; price = 600; };
	class V_PlateCarrierGL_rgr 						{ quality = 3; price = 600; };
	class V_PlateCarrierH_CTRG 						{ quality = 2; price = 500; };
	class V_PlateCarrierIA1_dgtl 					{ quality = 2; price = 300; };
	class V_PlateCarrierIA2_dgtl 					{ quality = 2; price = 400; };
	class V_PlateCarrierIAGL_dgtl 					{ quality = 3; price = 550; };
	class V_PlateCarrierIAGL_oli 					{ quality = 3; price = 550; };
	...
	// Caps
	///////////////////////////////////////////////////////////////////////////////
	class H_Cap_blk 								{ quality = 1; price = 60; };
	class H_Cap_blk_Raven 							{ quality = 1; price = 60; };
	class H_Cap_blu 								{ quality = 1; price = 60; };
	class H_Cap_brn_SPECOPS 						{ quality = 1; price = 60; };
	class H_Cap_grn 								{ quality = 1; price = 60; };
	class H_Cap_headphones 							{ quality = 1; price = 60; };
	class H_Cap_khaki_specops_UK 					{ quality = 1; price = 60; };
	class H_Cap_oli 								{ quality = 1; price = 60; };
	class H_Cap_press 								{ quality = 1; price = 60; };
	class H_Cap_red 								{ quality = 1; price = 60; };
	class H_Cap_tan 								{ quality = 1; price = 60; };
	class H_Cap_tan_specops_US 						{ quality = 1; price = 80; };
	...
	// Bandannas
	///////////////////////////////////////////////////////////////////////////////
	class H_Bandanna_camo							{ quality = 1; price = 50; };
	class H_Bandanna_cbr							{ quality = 1; price = 50; };
	class H_Bandanna_gry							{ quality = 1; price = 50; };
	class H_Bandanna_khk							{ quality = 1; price = 50; };
	class H_Bandanna_khk_hs							{ quality = 1; price = 50; };
	class H_Bandanna_mcamo							{ quality = 1; price = 50; };
	class H_Bandanna_sgg							{ quality = 1; price = 50; };
	class H_Bandanna_surfer							{ quality = 1; price = 50; };
	...
	class Exile_Headgear_SantaHat					{ quality = 1; price = 60; };
	class Exile_Headgear_SafetyHelmet				{ quality = 1; price = 60; };

	///////////////////////////////////////////////////////////////////////////////
	// Berets
	///////////////////////////////////////////////////////////////////////////////
	class H_Beret_02								{ quality = 2; price = 60; };
	class H_Beret_blk								{ quality = 2; price = 60; };
	class H_Beret_blk_POLICE						{ quality = 2; price = 60; };
	class H_Beret_brn_SF							{ quality = 2; price = 60; };
	class H_Beret_Colonel							{ quality = 3; price = 80; };
	class H_Beret_grn								{ quality = 2; price = 60; };
	class H_Beret_grn_SF							{ quality = 2; price = 60; };
	class H_Beret_ocamo								{ quality = 2; price = 60; };
	class H_Beret_red								{ quality = 2; price = 60; };
	...
	// Light Helmets
	///////////////////////////////////////////////////////////////////////////////
	class H_HelmetB_light							{ quality = 2; price = 250; };
	class H_HelmetB_light_black						{ quality = 2; price = 250; };
	class H_HelmetB_light_desert					{ quality = 2; price = 250; };
	class H_HelmetB_light_grass						{ quality = 2; price = 250; };
	class H_HelmetB_light_sand						{ quality = 2; price = 250; };
	class H_HelmetB_light_snakeskin					{ quality = 2; price = 250; };
	...
	// Pointer Attachments
	///////////////////////////////////////////////////////////////////////////////
	class acc_flashlight 							{ quality = 1; price = 20; };
	...
	class muzzle_snds_B 							{ quality = 3; price = 50; };
	...
	class optic_DMS									{ quality = 2; price = 300; };
	class optic_Hamr								{ quality = 3; price = 400; };
	class optic_Holosight							{ quality = 1; price = 150; };
	class optic_Holosight_smg						{ quality = 1; price = 150; };
	class optic_KHS_blk								{ quality = 3; price = 500; };
	class optic_KHS_hex								{ quality = 3; price = 500; };
	class optic_KHS_old								{ quality = 3; price = 500; };
	class optic_KHS_tan								{ quality = 3; price = 500; };
	class optic_LRPS								{ quality = 2; price = 600; };
	class optic_MRCO								{ quality = 1; price = 300; };
	class optic_MRD									{ quality = 1; price = 100; };
	class optic_Nightstalker						{ quality = 3; price = 1500; };
	class optic_NVS									{ quality = 2; price = 800; };
	class optic_SOS									{ quality = 2; price = 400; };
	...
	// Food
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Item_EMRE							{ quality = 3; price = 200; }; //75, 60
	class Exile_Item_GloriousKnakworst				{ quality = 3; price = 150; }; //60, 30
	class Exile_Item_Surstromming					{ quality = 3; price = 100; }; //55, 25
	class Exile_Item_SausageGravy					{ quality = 3; price = 100; }; //50, 25
	class Exile_Item_Catfood						{ quality = 2; price = 75; }; //40, 40
	class Exile_Item_ChristmasTinner				{ quality = 3; price = 75; }; //40, 60
	class Exile_Item_BBQSandwich					{ quality = 3; price = 75; }; //40, 60
	class Exile_Item_MacasCheese					{ quality = 3; price = 50; }; //40, 60
	...
	class Exile_Item_Noodles						{ quality = 1; price = 50; }; //25, 50
	class Exile_Item_SeedAstics						{ quality = 1; price = 50; }; //20, 40
	class Exile_Item_Raisins						{ quality = 1; price = 50; }; //15, 30
	class Exile_Item_Moobar							{ quality = 1; price = 30; }; //10, 30
	...
	// Drinks
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Item_PlasticBottleCoffee	 		{ quality = 3; price = 200; sellPrice = 10; };//100, 60
	class Exile_Item_PowerDrink						{ quality = 3; price = 180; }; //95, 10
	class Exile_Item_PlasticBottleFreshWater 		{ quality = 2; price = 150; sellPrice = 4; }; //80, 15
	class Exile_Item_Beer 							{ quality = 1; price = 150; }; //75, 30
	class Exile_Item_EnergyDrink					{ quality = 1; price = 150; }; //75, 20
	class Exile_Item_ChocolateMilk					{ quality = 1; price = 75; }; //75, 20
	class Exile_Item_MountainDupe					{ quality = 1; price = 100; }; //50, 20
	class Exile_Item_PlasticBottleEmpty				{ quality = 1; price = 10; };

	///////////////////////////////////////////////////////////////////////////////
	// First Aid
	///////////////////////////////////////////////////////////////////////////////	
	class Exile_Item_InstaDoc                       { quality = 1; price = 1000; };
	...
	class Exile_Item_Defibrillator				    { quality = 1; price = 3000; };
	
	///////////////////////////////////////////////////////////////////////////////
	// Tools
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Item_Matches 						{ quality = 1; price = 80; };
	class Exile_Item_CookingPot						{ quality = 2; price = 100; };
	...
	// Navigation
	///////////////////////////////////////////////////////////////////////////////
	class ItemWatch									{ quality = 1; price = 40; };	
	class ItemGPS									{ quality = 2; price = 40; };
	class ItemMap									{ quality = 1; price = 40; };
	class ItemCompass								{ quality = 1; price = 40; };
	class ItemRadio									{ quality = 1; price = 40; };
	class Binocular									{ quality = 1; price = 100; };
	...
	class Exile_Item_MobilePhone					{ quality = 3; price = 500; };
	...
	// Pilot Stuff
	///////////////////////////////////////////////////////////////////////////////
	class B_Parachute								{ quality = 3; price = 300; };
	class H_CrewHelmetHeli_B						{ quality = 2; price = 300; };
	class H_CrewHelmetHeli_I						{ quality = 2; price = 300; };
	class H_CrewHelmetHeli_O						{ quality = 2; price = 300; };
	class H_HelmetCrew_I							{ quality = 1; price = 300; };
	class H_HelmetCrew_B							{ quality = 1; price = 300; };
	class H_HelmetCrew_O							{ quality = 1; price = 300; };
	class H_PilotHelmetHeli_B						{ quality = 3; price = 350; };
	class H_PilotHelmetHeli_I						{ quality = 3; price = 100; };
	class H_PilotHelmetHeli_O						{ quality = 3; price = 100; };
	class U_B_HeliPilotCoveralls					{ quality = 1; price = 300; };
	class U_B_PilotCoveralls						{ quality = 1; price = 400; };
	class U_I_HeliPilotCoveralls					{ quality = 1; price = 300; };
	class U_I_pilotCoveralls						{ quality = 1; price = 400; };
	class U_O_PilotCoveralls						{ quality = 1; price = 400; };
	class H_PilotHelmetFighter_B					{ quality = 2; price = 250; };
	class H_PilotHelmetFighter_I					{ quality = 2; price = 250; };
	class H_PilotHelmetFighter_O					{ quality = 2; price = 250; };

	///////////////////////////////////////////////////////////////////////////////
	// Backpacks
	///////////////////////////////////////////////////////////////////////////////
	class B_HuntingBackpack							{ quality = 3; price = 200; };
	class B_OutdoorPack_blk							{ quality = 1; price = 200; };
	class B_OutdoorPack_blu							{ quality = 1; price = 200; };
	class B_OutdoorPack_tan							{ quality = 1; price = 200; };
	class B_AssaultPack_blk							{ quality = 1; price = 300; };
	class B_AssaultPack_cbr							{ quality = 1; price = 300; };
	class B_AssaultPack_dgtl						{ quality = 1; price = 300; };
	class B_AssaultPack_khk							{ quality = 1; price = 300; };
	class B_AssaultPack_mcamo						{ quality = 1; price = 300; };
	class B_AssaultPack_rgr							{ quality = 1; price = 300; };
	class B_AssaultPack_sgg							{ quality = 1; price = 300; };
	class B_FieldPack_blk							{ quality = 2; price = 400; };
	class B_FieldPack_cbr							{ quality = 2; price = 400; };
	class B_FieldPack_ocamo							{ quality = 2; price = 400; };
	class B_FieldPack_oucamo						{ quality = 2; price = 400; };
	class B_TacticalPack_blk						{ quality = 2; price = 500; };
	class B_TacticalPack_rgr						{ quality = 2; price = 500; };
	class B_TacticalPack_ocamo						{ quality = 2; price = 500; };
	class B_TacticalPack_mcamo						{ quality = 2; price = 500; };
	class B_TacticalPack_oli						{ quality = 2; price = 500; };
	class B_Kitbag_cbr								{ quality = 3; price = 600; };
	class B_Kitbag_mcamo							{ quality = 3; price = 600; };
	class B_Kitbag_sgg								{ quality = 3; price = 600; };
	class B_Bergen_blk								{ quality = 3; price = 600; };
	class B_Bergen_mcamo							{ quality = 3; price = 600; };
	class B_Bergen_rgr								{ quality = 3; price = 600; };
	class B_Bergen_sgg								{ quality = 3; price = 600; };
	class B_Carryall_cbr							{ quality = 2; price = 800; };
	class B_Carryall_khk							{ quality = 2; price = 800; };
	class B_Carryall_mcamo							{ quality = 2; price = 800; };
	class B_Carryall_ocamo							{ quality = 2; price = 800; };
	class B_Carryall_oli							{ quality = 2; price = 800; };
	class B_Carryall_oucamo							{ quality = 2; price = 800; };
	...
	// Broken in Arma
	class 10Rnd_338_Mag 									{ quality = 1; price = 60; };

	class 10Rnd_762x54_Mag 									{ quality = 1; price = 50; };
	...
	class 150Rnd_762x54_Box 								{ quality = 1; price = 80; };
	class 150Rnd_762x54_Box_Tracer 							{ quality = 1; price = 50; };
	class 16Rnd_9x21_Mag 									{ quality = 1; price = 50; };
	class 200Rnd_65x39_cased_Box 							{ quality = 1; price = 80; };
	class 200Rnd_65x39_cased_Box_Tracer 					{ quality = 2; price = 80; };
	class 150Rnd_93x64_Mag 									{ quality = 1; price = 100; };
	class 130Rnd_338_Mag 									{ quality = 1; price = 100; };
	class 20Rnd_556x45_UW_mag 								{ quality = 1; price = 40; };
	...
	class 30Rnd_556x45_Stanag_Tracer_Red 					{ quality = 2; price = 40; };
	class 30Rnd_556x45_Stanag_Tracer_Yellow 				{ quality = 2; price = 40; };
	class 30Rnd_556x45_Stanag_red 							{ quality = 2; price = 40; };
	...
	class 6Rnd_GreenSignal_F 								{ quality = 9000; price = 50; };
	class 6Rnd_RedSignal_F 									{ quality = 9000; price = 50; };
	...
	class Exile_Magazine_5Rnd_127x108_Bullet_Cam_Mag		{ quality = 2; price = 300; };
	class Exile_Magazine_10Rnd_93x64_DMR_05_Bullet_Cam_Mag	{ quality = 2; price = 280; };
	class Exile_Magazine_7Rnd_408_Bullet_Cam_Mag			{ quality = 2; price = 330; };
	class Exile_Magazine_10Rnd_338_Bullet_Cam_Mag			{ quality = 2; price = 320; };
	...
	class FlareGreen_F								{ quality = 1; price = 40; };
	class FlareRed_F								{ quality = 1; price = 40; };
	class FlareWhite_F								{ quality = 1; price = 40; };
	class FlareYellow_F								{ quality = 1; price = 40; };
	class UGL_FlareGreen_F							{ quality = 2; price = 40; };
	class UGL_FlareRed_F							{ quality = 2; price = 40; };
	class UGL_FlareWhite_F							{ quality = 2; price = 40; };
	class UGL_FlareYellow_F							{ quality = 2; price = 40; };
	class 3Rnd_UGL_FlareGreen_F						{ quality = 3; price = 75*3; };
	class 3Rnd_UGL_FlareRed_F						{ quality = 3; price = 75*3; };
	class 3Rnd_UGL_FlareWhite_F						{ quality = 3; price = 75*3; };
	class 3Rnd_UGL_FlareYellow_F					{ quality = 3; price = 75*3; };

	///////////////////////////////////////////////////////////////////////////////
	// Smokes
	///////////////////////////////////////////////////////////////////////////////
	class SmokeShell								{ quality = 1; price = 40; };
	class SmokeShellBlue							{ quality = 1; price = 40; };
	class SmokeShellGreen							{ quality = 1; price = 40; };
	class SmokeShellOrange							{ quality = 1; price = 40; };
	class SmokeShellPurple							{ quality = 1; price = 40; };
	class SmokeShellRed								{ quality = 1; price = 40; };
	class SmokeShellYellow							{ quality = 1; price = 40; };
	class 1Rnd_Smoke_Grenade_shell					{ quality = 2; price = 40; };
	class 1Rnd_SmokeBlue_Grenade_shell				{ quality = 2; price = 40; };
	class 1Rnd_SmokeGreen_Grenade_shell				{ quality = 2; price = 40; };
	class 1Rnd_SmokeOrange_Grenade_shell			{ quality = 2; price = 40; };
	class 1Rnd_SmokePurple_Grenade_shell			{ quality = 2; price = 40; };
	class 1Rnd_SmokeRed_Grenade_shell				{ quality = 2; price = 40; };
	class 1Rnd_SmokeYellow_Grenade_shell			{ quality = 2; price = 40; };
	class 3Rnd_Smoke_Grenade_shell					{ quality = 3; price = 120*3; };
	class 3Rnd_SmokeBlue_Grenade_shell				{ quality = 3; price = 120*3; };
	class 3Rnd_SmokeGreen_Grenade_shell				{ quality = 3; price = 120*3; };
	class 3Rnd_SmokeOrange_Grenade_shell			{ quality = 3; price = 120*3; };
	class 3Rnd_SmokePurple_Grenade_shell			{ quality = 3; price = 120*3; };
	class 3Rnd_SmokeRed_Grenade_shell				{ quality = 3; price = 120*3; };
	class 3Rnd_SmokeYellow_Grenade_shell			{ quality = 3; price = 120*3; };
	...
	class B_IR_Grenade								{ quality = 1; price = 60; };
	class O_IR_Grenade								{ quality = 1; price = 60; };
	class I_IR_Grenade								{ quality = 1; price = 60; };
	class 1Rnd_HE_Grenade_shell						{ quality = 2; price = 100; };
	class 3Rnd_HE_Grenade_shell						{ quality = 3; price = 300*3; };
	...
	class hgun_Pistol_heavy_02_F 					{ quality = 2; price = 250; };
	class hgun_Pistol_Signal_F 						{ quality = 9000; price = 200; };
	...
	class SMG_01_F 									{ quality = 1; price = 200; };
	class SMG_02_F 									{ quality = 1; price = 200; };
	...
	class LMG_Mk200_F								{ quality = 2; price = 700; };
	class LMG_Zafir_F								{ quality = 2; price = 1000; };
	class MMG_01_hex_F								{ quality = 1; price = 1500; };
	class MMG_01_tan_F								{ quality = 1; price = 2000; };
	class MMG_02_black_F							{ quality = 1; price = 2000; };
	class MMG_02_camo_F								{ quality = 1; price = 200; };
	class MMG_02_sand_F								{ quality = 1; price = 2000; };

	///////////////////////////////////////////////////////////////////////////////
	// Assault Rifles
	///////////////////////////////////////////////////////////////////////////////
	class arifle_Katiba_C_F							{ quality = 1; price = 400; };
	class arifle_Katiba_F							{ quality = 1; price = 400; };
	class arifle_Katiba_GL_F						{ quality = 2; price = 500; };
	class arifle_Mk20_F								{ quality = 1; price = 300; };
	class arifle_Mk20_GL_F							{ quality = 2; price = 400; };
	class arifle_Mk20_GL_plain_F					{ quality = 2; price = 400; };
	class arifle_Mk20_plain_F						{ quality = 1; price = 300; };
	class arifle_Mk20C_F							{ quality = 1; price = 300; };
	class arifle_Mk20C_plain_F						{ quality = 1; price = 300; };
	class arifle_MX_Black_F							{ quality = 1; price = 450; };
	class arifle_MX_F								{ quality = 1; price = 450; };
	class arifle_MX_GL_Black_F						{ quality = 2; price = 500; };
	class arifle_MX_GL_F							{ quality = 2; price = 500; };
	...
	// Sniper Rifles
	///////////////////////////////////////////////////////////////////////////////
	class arifle_MXM_Black_F 						{ quality = 1; price = 600; };
	class arifle_MXM_F 								{ quality = 1; price = 600; };
	class srifle_DMR_01_F 							{ quality = 2; price = 1500; };
	class srifle_DMR_02_camo_F 						{ quality = 1; price = 2000; };
	class srifle_DMR_02_F 							{ quality = 1; price = 2000; };
	class srifle_DMR_02_sniper_F 					{ quality = 1; price = 2000; };
	...
	class srifle_DMR_04_F 							{ quality = 1; price = 1500; };
	class srifle_DMR_04_Tan_F 						{ quality = 1; price = 1500; };
	class srifle_DMR_05_blk_F 						{ quality = 1; price = 2500; };
	class srifle_DMR_05_hex_F 						{ quality = 1; price = 2500; };
	class srifle_DMR_05_tan_f 						{ quality = 1; price = 2500; };
	class srifle_DMR_06_camo_F 						{ quality = 3; price = 2000; };
	class srifle_DMR_06_olive_F 					{ quality = 3; price = 2000; };
	class srifle_EBR_F 								{ quality = 2; price = 1500; };
	class srifle_GM6_camo_F 						{ quality = 1; price = 3000; };
	class srifle_GM6_F 								{ quality = 1; price = 3000; };
	class srifle_LRR_camo_F 						{ quality = 1; price = 2750; };
	class srifle_LRR_F 								{ quality = 1; price = 2750; };
	...
	class arifle_MX_khk_F             { quality = 2; price = 700; };
	class arifle_MX_GL_khk_F          { quality = 2; price = 700; };
	class arifle_MXC_khk_F            { quality = 2; price = 700; };
	class arifle_MXM_khk_F            { quality = 2; price = 700; };
	class srifle_LRR_tna_F            { quality = 3; price = 2750; };
	class srifle_GM6_ghex_F           { quality = 3; price = 3000; };
	class srifle_DMR_07_blk_F         { quality = 3; price = 1000; };
	class srifle_DMR_07_hex_F         { quality = 3; price = 1000; };
	class srifle_DMR_07_ghex_F        { quality = 3; price = 1000; };
	class arifle_AK12_F               { quality = 2; price = 700; };
	class arifle_AK12_GL_F            { quality = 2; price = 700; };
	class arifle_AKM_F                { quality = 2; price = 700; };
	class arifle_AKM_FL_F             { quality = 2; price = 700; };
	class arifle_AKS_F                { quality = 2; price = 700; };
	class arifle_ARX_blk_F            { quality = 2; price = 700; };
	class arifle_ARX_ghex_F           { quality = 2; price = 700; };
	class arifle_ARX_hex_F            { quality = 2; price = 700; };
	class arifle_CTAR_blk_F           { quality = 2; price = 600; };
	class arifle_CTAR_hex_F           { quality = 2; price = 700; };
	class arifle_CTAR_ghex_F          { quality = 2; price = 700; };
	class arifle_CTAR_GL_blk_F        { quality = 2; price = 700; };
	class arifle_CTARS_blk_F          { quality = 2; price = 600; };
	class arifle_CTARS_ghex_F         { quality = 2; price = 600; };
	class arifle_CTARS_hex_F          { quality = 2; price = 600; };
	class arifle_SPAR_01_blk_F        { quality = 2; price = 700; };
	class arifle_SPAR_01_khk_F        { quality = 2; price = 700; };
	class arifle_SPAR_01_snd_F        { quality = 2; price = 700; };
	class arifle_SPAR_01_GL_blk_F     { quality = 2; price = 700; };
	class arifle_SPAR_01_GL_khk_F     { quality = 2; price = 700; };
	class arifle_SPAR_01_GL_snd_F     { quality = 1; price = 700; };
	class arifle_SPAR_02_blk_F        { quality = 2; price = 700; };
	class arifle_SPAR_02_khk_F        { quality = 2; price = 700; };
	class arifle_SPAR_02_snd_F        { quality = 2; price = 700; };
	class arifle_SPAR_03_blk_F        { quality = 2; price = 700; };
	class arifle_SPAR_03_khk_F        { quality = 2; price = 700; };
	class arifle_SPAR_03_snd_F        { quality = 2; price = 700; };					
	...
	class optic_DMS_ghex_F            { quality = 2; price = 300; };
	class optic_Hamr_khk_F            { quality = 3; price = 400; };
	class optic_ERCO_blk_F            { quality = 1; price = 150; };
	class optic_ERCO_khk_F            { quality = 1; price = 150; };
	class optic_ERCO_snd_F            { quality = 1; price = 150; };
	class optic_SOS_khk_F             { quality = 2; price = 400; };
	class optic_LRPS_tna_F            { quality = 2; price = 600; };
	class optic_LRPS_ghex_F           { quality = 2; price = 600; };
	...
	class bipod_01_F_khk              { quality = 1; price = 50; };
	...
	class U_B_T_Soldier_F             { quality = 1; price = 400; };
	class U_B_T_Soldier_AR_F          { quality = 1; price = 400; };
	class U_B_T_Soldier_SL_F          { quality = 1; price = 40; };
	class U_B_T_Sniper_F              { quality = 3; price = 700; };
	class U_B_T_FullGhillie_tna_F     { quality = 3; price = 800; };
	class U_B_CTRG_Soldier_F          { quality = 1; price = 400; };
	class U_B_CTRG_Soldier_2_F        { quality = 1; price = 400; };
	class U_B_CTRG_Soldier_3_F        { quality = 1; price = 400; };
	class U_B_GEN_Soldier_F           { quality = 1; price = 400; };
	class U_B_GEN_Commander_F         { quality = 1; price = 400; };
	class U_O_T_Soldier_F             { quality = 1; price = 400; };
	class U_O_T_Officer_F             { quality = 1; price = 400; };
	class U_O_T_Sniper_F              { quality = 3; price = 700; };
	class U_O_T_FullGhillie_tna_F     { quality = 3; price = 800; };
	class U_O_V_Soldier_Viper_F       { quality = 3; price = 700; };
	class U_O_V_Soldier_Viper_hex_F   { quality = 3; price = 800; };
	class U_I_C_Soldier_Para_1_F      { quality = 1; price = 400; };
	class U_I_C_Soldier_Para_2_F      { quality = 1; price = 400; };
	class U_I_C_Soldier_Para_3_F      { quality = 1; price = 400; };
	class U_I_C_Soldier_Para_4_F      { quality = 1; price = 400; };
	class U_I_C_Soldier_Para_5_F      { quality = 1; price = 400; };
	class U_I_C_Soldier_Bandit_1_F    { quality = 1; price = 400; };
	class U_I_C_Soldier_Bandit_2_F    { quality = 1; price = 400; };
	class U_I_C_Soldier_Bandit_3_F    { quality = 1; price = 400; };
	class U_I_C_Soldier_Bandit_4_F    { quality = 1; price = 400; };
	class U_I_C_Soldier_Bandit_5_F    { quality = 1; price = 400; };
	class U_I_C_Soldier_Camo_F        { quality = 1; price = 400; };
	class U_C_man_sport_1_F           { quality = 1; price = 400; };
	class U_C_man_sport_2_F           { quality = 1; price = 400; };
	class U_C_man_sport_3_F           { quality = 1; price = 400; };
	class U_C_Man_casual_1_F          { quality = 1; price = 400; };
	class U_C_Man_casual_2_F          { quality = 1; price = 400; };
	class U_C_Man_casual_3_F          { quality = 1; price = 400; };
	class U_C_Man_casual_4_F          { quality = 1; price = 400; };
	class U_C_Man_casual_5_F          { quality = 1; price = 400; };
	class U_C_Man_casual_6_F          { quality = 1; price = 400; };
	class U_B_CTRG_Soldier_urb_1_F    { quality = 1; price = 400; };
	class U_B_CTRG_Soldier_urb_2_F    { quality = 1; price = 400; };
	class U_B_CTRG_Soldier_urb_3_F    { quality = 1; price = 400; };
	class H_Helmet_Skate              { quality = 1; price = 400; };
	class H_HelmetB_TI_tna_F          { quality = 1; price = 300; };
	//class H_HelmetO_ViperSP_hex_F     { quality = 4; price = 1000; };		//Themal
	//class H_HelmetO_ViperSP_ghex_F    { quality = 4; price = 1000; }; 	//Themal 
	class H_HelmetB_tna_F             { quality = 1; price = 300; };
	class H_HelmetB_Enh_tna_F         { quality = 1; price = 300; };
	class H_HelmetB_Light_tna_F       { quality = 1; price = 300; };
	class H_HelmetSpecO_ghex_F        { quality = 1; price = 300; };
	class H_HelmetLeaderO_ghex_F      { quality = 1; price = 300; };
	class H_HelmetO_ghex_F            { quality = 1; price = 300; };
	class H_HelmetCrew_O_ghex_F       { quality = 1; price = 300; };
	class H_MilCap_tna_F              { quality = 1; price = 50; };
	class H_MilCap_ghex_F             { quality = 1; price = 50; };
	class H_Booniehat_tna_F           { quality = 1; price = 50; };
	class H_Beret_gen_F               { quality = 1; price = 50; };
	class H_MilCap_gen_F              { quality = 1; price = 50; };
	class H_Cap_oli_Syndikat_F        { quality = 1; price = 50; };
	class H_Cap_tan_Syndikat_F        { quality = 1; price = 50; };
	class H_Cap_blk_Syndikat_F        { quality = 1; price = 50; };
	class H_Cap_grn_Syndikat_F        { quality = 1; price = 50; };
	class H_FakeHeadgear_Syndikat_F   { quality = 1; price = 50; };
	...
	class V_PlateCarrier1_tna_F       { quality = 3; price = 550; };
	class V_PlateCarrier2_tna_F       { quality = 3; price = 550; };
	class V_PlateCarrierSpec_tna_F    { quality = 3; price = 550; };
	class V_PlateCarrierGL_tna_F      { quality = 3; price = 550; };
	class V_HarnessO_ghex_F           { quality = 3; price = 550; };
	class V_HarnessOGL_ghex_F         { quality = 3; price = 550; };
	class V_BandollierB_ghex_F        { quality = 3; price = 550; };
	class V_TacVest_gen_F             { quality = 3; price = 550; };
	class V_PlateCarrier1_rgr_noflag_F		{ quality = 3; price = 550; };
	class V_PlateCarrier2_rgr_noflag_F		{ quality = 3; price = 550; };
	class B_Bergen_Base_F					{ quality = 2; price = 600; };
	class B_Bergen_mcamo_F                  { quality = 2; price = 600; };
	class B_Bergen_dgtl_F                   { quality = 2; price = 600; };
	class B_Bergen_hex_F                    { quality = 2; price = 600; };
	class B_Bergen_tna_F                    { quality = 2; price = 600; };
	class B_AssaultPack_tna_F               { quality = 2; price = 600; };
	class B_Carryall_ghex_F                 { quality = 2; price = 600; };
	class B_FieldPack_ghex_F                { quality = 2; price = 600; };
	class B_ViperHarness_base_F             { quality = 2; price = 600; };
	class B_ViperHarness_blk_F              { quality = 3; price = 600; };
	class B_ViperHarness_ghex_F             { quality = 3; price = 600; };
	class B_ViperHarness_hex_F              { quality = 3; price = 600; };
	class B_ViperHarness_khk_F              { quality = 3; price = 600; };
	class B_ViperHarness_oli_F              { quality = 3; price = 600; };
	class B_ViperLightHarness_base_F        { quality = 2; price = 500; };
	class B_ViperLightHarness_blk_F         { quality = 2; price = 500; };
	class B_ViperLightHarness_ghex_F        { quality = 2; price = 500; };
	class B_ViperLightHarness_hex_F         { quality = 2; price = 500; };
	class B_ViperLightHarness_khk_F         { quality = 2; price = 500; };
	class B_ViperLightHarness_oli_F         { quality = 2; price = 500; };
	
	class 30Rnd_9x21_Mag_SMG_02						{quality = 1; price = 50; };
	class 30Rnd_9x21_Mag_SMG_02_Tracer_Red          {quality = 1; price = 50; };
	class 30Rnd_9x21_Mag_SMG_02_Tracer_Yellow       {quality = 1; price = 50; };
	class 30Rnd_9x21_Mag_SMG_02_Tracer_Green        {quality = 1; price = 50; };
	class 30Rnd_580x42_Mag_F                        {quality = 2; price = 50; };
	class 30Rnd_580x42_Mag_Tracer_F                 {quality = 2; price = 50; };
	class 100Rnd_580x42_Mag_F                       {quality = 2; price = 50; };
	class 100Rnd_580x42_Mag_Tracer_F                {quality = 2; price = 50; };
	class 20Rnd_650x39_Cased_Mag_F                  {quality = 4; price = 50; };
	class 10Rnd_50BW_Mag_F                          {quality = 5; price = 50; };
	class 150Rnd_556x45_Drum_Mag_F                  {quality = 2; price = 175; };
	class 150Rnd_556x45_Drum_Mag_Tracer_F           {quality = 2; price = 175; };
	class 30Rnd_762x39_Mag_F                        {quality = 2; price = 50; };
	class 30Rnd_762x39_Mag_Green_F                  {quality = 2; price = 50; };
	class 30Rnd_762x39_Mag_Tracer_F                 {quality = 2; price = 50; };
	class 30Rnd_762x39_Mag_Tracer_Green_F           {quality = 2; price = 50; };
	class 30Rnd_545x39_Mag_F                        {quality = 2; price = 50; };
	class 30Rnd_545x39_Mag_Green_F                  {quality = 2; price = 50; };
	class 30Rnd_545x39_Mag_Tracer_F                 {quality = 2; price = 50; };
	class 30Rnd_545x39_Mag_Tracer_Green_F           {quality = 2; price = 50; };
	class 200Rnd_556x45_Box_F                       {quality = 2; price = 200; };
	class 200Rnd_556x45_Box_Red_F                   {quality = 2; price = 200; };
	class 200Rnd_556x45_Box_Tracer_F                {quality = 2; price = 200; };
	class 200Rnd_556x45_Box_Tracer_Red_F            {quality = 2; price = 200; };
	...
	// KARTS
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Kart_BluKing					{ quality = 1; price = 900; };
	class Exile_Car_Kart_RedStone					{ quality = 1; price = 900; };
	class Exile_Car_Kart_Vrana						{ quality = 1; price = 900; };
	class Exile_Car_Kart_Green						{ quality = 1; price = 900; };
	class Exile_Car_Kart_Blue						{ quality = 1; price = 900; };
	class Exile_Car_Kart_Orange						{ quality = 1; price = 900; };
	class Exile_Car_Kart_White						{ quality = 1; price = 900; };
	class Exile_Car_Kart_Yellow						{ quality = 1; price = 900; };
	class Exile_Car_Kart_Black						{ quality = 1; price = 900; };
	...
	// Hellcat
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Chopper_Hellcat_Green				{ quality = 1; price = 17500; };
	class Exile_Chopper_Hellcat_FIA					{ quality = 1; price = 17500; };

	///////////////////////////////////////////////////////////////////////////////
	// Hummingbird
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Chopper_Hummingbird_Green			{ quality = 1; price = 13000; };
	...
	// Orca
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Chopper_Orca_CSAT								{ quality = 1; price = 20000; };
	class Exile_Chopper_Orca_Black								{ quality = 1; price = 20000; };
	class Exile_Chopper_Orca_BlackCustom						{ quality = 1; price = 20000; };
	...
	class Exile_Chopper_Taru_Covered_CSAT						{ quality = 1; price = 25000; };
	class Exile_Chopper_Taru_Covered_Black						{ quality = 1; price = 25000; };
	...
	// Golf
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Golf_Red							{ quality = 1; price = 5000; };
	class Exile_Car_Golf_Black							{ quality = 1; price = 5000; };

	///////////////////////////////////////////////////////////////////////////////
	// Ikarus
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Ikarus_Blue 				{ quality = 1; price = 5000; };
	class Exile_Car_Ikarus_Red 					{ quality = 1; price = 5000; };
	class Exile_Car_Ikarus_Party 				{ quality = 1; price = 5000; };
	...
	// V3S
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_V3S_Open			{ quality = 2; price = 15000; };
	class Exile_Car_V3S_Covered			{ quality = 2; price = 15000; };

	///////////////////////////////////////////////////////////////////////////////
	// SUVXL
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_SUVXL_Black 				{ quality = 1; price = 10000; };
	...
	// Tractor (Old)
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_OldTractor_Red 				{ quality = 1; price = 1000; };
	...
	// Land Rover
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_LandRover_Red 				{ quality = 1; price = 5500; };
	class Exile_Car_LandRover_Urban 			{ quality = 1; price = 5500; };
	class Exile_Car_LandRover_Green 			{ quality = 1; price = 5500; };
	class Exile_Car_LandRover_Sand 				{ quality = 1; price = 5500; };
	class Exile_Car_LandRover_Desert 			{ quality = 1; price = 5500; };

	///////////////////////////////////////////////////////////////////////////////
	// Land Rover (Ambulance)
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_LandRover_Ambulance_Green		{ quality = 1; price = 6000; };
	class Exile_Car_LandRover_Ambulance_Desert		{ quality = 1; price = 6000; };
	class Exile_Car_LandRover_Ambulance_Sand		{ quality = 1; price = 6000; };
	...
	// Hatchback (Sport)
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Hatchback_Sport_Red					{ quality = 1; price = 7000; };
	class Exile_Car_Hatchback_Sport_Blue				{ quality = 1; price = 7000; };
	class Exile_Car_Hatchback_Sport_Orange				{ quality = 1; price = 7000; };
	class Exile_Car_Hatchback_Sport_White				{ quality = 1; price = 7000; };
	class Exile_Car_Hatchback_Sport_Beige				{ quality = 1; price = 7000; };
	class Exile_Car_Hatchback_Sport_Green				{ quality = 1; price = 7000; };

	///////////////////////////////////////////////////////////////////////////////
	// HEMMT
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_HEMMT 								{ quality = 1; price = 20000; };
	...
	// Offroad (Armed)
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Offroad_Armed_Guerilla01 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla02 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla03 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla04 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla05 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla06 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla07 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla08 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla09 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla10 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla11 			{ quality = 1; price = 10000; };
	class Exile_Car_Offroad_Armed_Guerilla12 			{ quality = 1; price = 10000; };

	///////////////////////////////////////////////////////////////////////////////
	// Offroad (Repair)
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Offroad_Repair_Civillian 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Red 					{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Beige 				{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_White 				{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Blue 				{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_DarkRed 				{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_BlueCustom 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla01 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla02 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla03 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla04 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla05 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla06 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla07 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla08 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla09 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla10 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla11 			{ quality = 1; price = 7500; };
	class Exile_Car_Offroad_Repair_Guerilla12 			{ quality = 1; price = 7500; };
	...
	// SUV
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_SUV_Red 							{ quality = 1; price = 10000; };
	class Exile_Car_SUV_Black 							{ quality = 1; price = 10000; };
	class Exile_Car_SUV_Grey 							{ quality = 1; price = 10000; };
	class Exile_Car_SUV_Orange 							{ quality = 1; price = 10000; };
	...
	// Van 
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Van_Black 							{ quality = 1; price = 8000; };
	class Exile_Car_Van_White 							{ quality = 1; price = 8000; };
	class Exile_Car_Van_Red 							{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla01 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla02 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla03 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla04 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla05 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla06 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla07 						{ quality = 1; price = 8000; };
	class Exile_Car_Van_Guerilla08 						{ quality = 1; price = 8000; };

	///////////////////////////////////////////////////////////////////////////////
	// Van (Box) 
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Van_Box_Black 						{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_White 						{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Red 						{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla01 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla02 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla03 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla04 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla05 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla06 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla07 					{ quality = 1; price = 12000; };
	class Exile_Car_Van_Box_Guerilla08 					{ quality = 1; price = 12000; };

	///////////////////////////////////////////////////////////////////////////////
	// Van (Fuel) 
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Van_Fuel_Black 						{ quality = 1; price = 13000; };
	class Exile_Car_Van_Fuel_White 						{ quality = 1; price = 13000; };
	class Exile_Car_Van_Fuel_Red 						{ quality = 1; price = 13000; };
	class Exile_Car_Van_Fuel_Guerilla01 				{ quality = 1; price = 13000; };
	class Exile_Car_Van_Fuel_Guerilla02 				{ quality = 1; price = 13000; };
	class Exile_Car_Van_Fuel_Guerilla03 				{ quality = 1; price = 13000; };

	///////////////////////////////////////////////////////////////////////////////
	// Zamak
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_Zamak 								{ quality = 1; price = 20000; };
	...
	// RHIB
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Boat_RHIB								{ quality = 3; price = 1000; };
	...
	// V-44 X Blackfish
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Plane_BlackfishInfantry							{ quality = 6; price = 25000; };
	class Exile_Plane_BlackfishVehicle							{ quality = 6; price = 25000; };
	
	///////////////////////////////////////////////////////////////////////////////
	// Prowler
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_ProwlerLight							{ quality = 3; price = 10000; };
	class Exile_Car_ProwlerUnarmed							{ quality = 3; price = 10000; };
	
	///////////////////////////////////////////////////////////////////////////////
	// Qilin
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_QilinUnarmed							{ quality = 3; price = 10000; };
	
	///////////////////////////////////////////////////////////////////////////////
	// MB 4WD
	///////////////////////////////////////////////////////////////////////////////
	class Exile_Car_MB4WD							    { quality = 2; price = 10000; };
	class Exile_Car_MB4WDOpen							{ quality = 2; price = 10000; };
	
	class B_Truck_01_ammo_F								{ quality = 6; price = 50000; sellPrice = 15000; };
	class B_Truck_01_Repair_F							{ quality = 6; price = 50000; sellPrice = 15000; };
	///////////////////////////////////////////////////////////////////////////////
	// Flags
	///////////////////////////////////////////////////////////////////////////////
...
class CfgExileCustomCode 
{
	...
	*/
	...
	ExileClient_object_player_death_startBleedingOut = "addons\EnigmaRevive\ExileClient_object_player_death_startBleedingOut.sqf"; //Happys Revive
    ExileClient_object_player_event_onInventoryOpened = "addons\EnigmaRevive\ExileClient_object_player_event_onInventoryOpened.sqf"; //Happys Revive AntiDupe ---NEW with v0.65
	ExileClient_object_item_construct = "addons\ExileClient_object_item_construct.sqf"; //Disables Building in locations
	//ExileClient_object_player_event_onEnterSafezon.sqf  = "addons\ExileClient_object_player_event_onEnterSafezon.sqf"; // Igiload
};
...
class CfgExileLootSettings
{
	 ...
	 */
	minimumDistanceToTerritories = 200;
};
...
class CfgInteractionMenus
{
	...
	class SupplyBox
	{
		...
		class Actions
		{
			...
			class Move: ExileAbstractAction //not sure if need
			{
				title = "Move";
...
class CfgTerritories
{
	...
	prices[] = 
	{
		...
		{5000,						15,			60 					}, // Level 1
		{15000,						30,			150 				}, // Level 2 
		{20000,						45,			180 				}, // Level 3
		{40000,						60,			240					}, // Level 4
		{55000,						75,			300					}, // Level 5
		{65000,						90,			360					}, // Level 6
		{80000,		  				105,		420					}, // Level 7
		{100000,					120,		450					}, // Level 8
		{150000,					120,		475					}, // Level 9
		{250000,					120,		500					}  // Level 10
	};
...
{
	/** Add Rebel trader **/
	//#include "addons\RebelCategory.hpp";
	class RebelLightMachineGuns 
	{
		name = "Rebel Light Machine Guns";
	...
	class RebelSniperRifles
	{
		name = "Rebel Sniper Rifles";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] = 
		{
	...
	class RebelAmmunition
	{
		name = "Rebel Ammunition";
		icon = "a3\ui_f\data\gui\Rsc\RscDisplayArsenal\itemacc_ca.paa";
		items[] = 
		{
			"10Rnd_127x54_Mag",
	...
	class RebelExplosives
	{
		name = "Rebel Explosives";
...
class CfgXM8
{
    //extraApps[] = {"ExAd_VG","ExAd_pMsg","ExAd_CHVD","ExAd_Journal","ExAd_Quad","ExAd_SB"};
	extraApps[] = {"ExAd_VG","ExAd_pMsg","ExAd_CHVD","ExAd_Journal","ExAd_SB","ExAd_Info","ExAd_Fantom"};
	
    class ExAd_VG 
    {
        title = "Virtual Garage";
        controlID = 50000;                  //IDC:50000 -> 50014
		logo = "addons\icon\tool2.paa";
    ...
    class ExAd_SB
    {
        ...
        logo = "addons\icon\interface2.paa";
    ...
    class ExAd_CHVD
    {
        ...
        controlID = 50200;                    //IDC:50200 -> 50202 || These need to be unique and out of range from each other
        config = "ExadClient\XM8\Apps\CHVD\config.sqf";
        logo = "addons\icon\binoc2.paa";
    ...
    {
        title = "Text Message";
        controlID = 50500;                    //IDC:50500 -> 50502 || These need to be unique and out of range from each other
        logo = "addons\icon\text2.paa";
        quickFunction = "createdialog 'infiSTAR_CHAT';";
    };
	class ExAd_Fantom
    {
        title = "Fantom Networks";
        controlID = 50600;                    //IDC:50600 -> 50602 || These need to be unique and out of range from each other
        logo = "addons\icon\fantom2.paa";
        quickFunction = "throw 'Coming soon'";
    };
};  