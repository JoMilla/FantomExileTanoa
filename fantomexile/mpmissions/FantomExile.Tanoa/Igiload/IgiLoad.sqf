...
if (isnil "IL_Variables") then
{
    ...
    IL_Para_Drop_Vehicles = IL_Supported_Vehicles_MH9 + IL_Supported_Vehicles_MOHAWK + IL_Supported_Vehicles_CHINOOK + IL_Supported_Vehicles_BLACKFISH + IL_Supported_Vehicles_Y32 + IL_Supported_Vehicles_HURON;
    ...
    IL_Supported_Cargo_NonVeh_HUNTER = IL_Supported_Supply_Crate + IL_Supported_Box_H1 + IL_Supported_Box_H2;
...
if (isnil "IL_Procedures") then
{
    ...
    IL_Do_Load =
    {
        ...
        {
            _sdist = IL_SDistL + IL_SDistL_Heli_offset;
            _spoint = _v modelToWorld [0,-6.5,-2.5];
            _box_num = _v getVariable "box_num";
            _slot_num = _v getVariable "slots_num";
        };
        ...
        {
            _sdist = IL_SDistL + IL_SDistL_Heli_offset;
            _spoint = _v modelToWorld [0,-9,-4.5];
            _box_num = _v getVariable "box_num";
            _slot_num = _v getVariable "slots_num";
        };
                ...
                {                  
                    if (_lock2 <= 1) then
                    {
                        ...
                        if ((_obj_type in IL_Supported_Vehicles_BLACKFISH)  && (_doors == "B")) then
                        {
                            ...
                            [_v, _x, [_x_cargo_offset,-2.5,_zload], [_x_cargo_offset,_counter + 13.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
                        };
                        if ((_obj_type in IL_Supported_Vehicles_Y32)  && (_doors == "B")) then
                        {
                            [_v, _x, [_x_cargo_offset,-5,-0.5 + _zload], [_x_cargo_offset,-3.5,-0.5 + _zload], 1, _turn] call IL_Move_Attach;
                            [_v, _x, [_x_cargo_offset,-3.5,-0.5 + _zload], [_x_cargo_offset,-2,_zload], 1, _turn] call IL_Move_Attach;
                            [_v, _x, [_x_cargo_offset,-2,_zload], [_x_cargo_offset,_counter + 7.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
                        };
                        if ((_obj_type in IL_Supported_Vehicles_HURON)  && (_doors == "B")) then
                        {
                            [_v, _x, [_x_cargo_offset,-9,-0.75 + _zload], [_x_cargo_offset,-7,-0.75 + _zload], 1, _turn] call IL_Move_Attach;
                            [_v, _x, [_x_cargo_offset,-7,-0.75 + _zload], [_x_cargo_offset,-4,_zload], 1, _turn] call IL_Move_Attach;
                            [_v, _x, [_x_cargo_offset,-4,_zload], [_x_cargo_offset,_counter + 7.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
                        };
                        if ((_obj_type in IL_Supported_Vehicles_HUNTER) && (_doors == "B")) then
                        {
                            [_v, _x, [_x_cargo_offset,-4.5,_zload], [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], 1, _turn] call IL_Move_Attach;
        ...
        {
            {
                ...
                if (_x getVariable "doors" == _doors) then
                {
                    ...
                    if (((_x getVariable "attachedTruck") == _v) && ((_x getVariable "attachedPos") == (_counter)) && (_counter < 0) && !_done) then
                    {
                        ...
                        if ((_obj_type in IL_Supported_Vehicles_HUNTER) && (_doors == "B")) then
                        {
                            [_v, _x, [_x_cargo_offset,_counter + 0.25 - _cargo_offset,_zload], [_x_cargo_offset,-5.5,_zload], 1, _turn] call IL_Move_Attach;
                        };
                        if ((_obj_type in IL_Supported_Vehicles_IFRIT) && (_doors == "B")) then
                        {
...
if (_obj_main_type in IL_Supported_Vehicles_BLACKFISH) then
{
    ...
    _obj_main addAction [
    "<t color=""#0000ff"">Open cargo ramp on Blackfish</t>",
    {
    ...
    _obj_main addAction [
    "<t color=""#0000ff"">Close cargo ramp on Blackfish</t>",
    {
...
if (_obj_main_type in IL_Supported_Vehicles_Y32) then
{
	...
	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">Load cargo in Y-32 Xian</t>",
	{
		[_this select 0, IL_Supported_Cargo_NonVeh_Y32] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.5,-2.5], IL_Supported_Cargo_NonVeh_Y32, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6.5,-2.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target doorPhase 'Door_1_source' == 1)"
	];

	_obj_main addAction [
	"<img image='IgiLoad\images\load.paa' /><t color=""#007f0e"">Load vehicle in Y-32 Xi'an</t>",
	{
		[_this select 0, IL_Supported_Cargo_Veh_Y32] call IL_Do_Load;
	},[],IL_Action_LU_Priority,true,true,"",
	"(count(nearestObjects[ _target modelToWorld [0,-6.5,-2.5], IL_Supported_Cargo_Veh_Y32, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6.5,-2.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target doorPhase 'Door_1_source' == 1)"
	];
	...
	"(_this in (nearestObjects[ _target modelToWorld [0,-6.5,-2.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && ((_target emptyPositions 'cargo') > 0) && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt) && (_target doorPhase 'Door_1_source' > 0.43) && (_target getVariable 'usable_ramp')"
	];
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Open cargo ramp on Y-32 Xian</t>",
	{
		_this select 0 animatedoor ['Door_1_source', 1];
	},[],IL_Action_O_Priority,false,true,"",
	"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6.5,-2.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target doorPhase 'Door_1_source' == 0) && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<t color=""#0000ff"">Close cargo ramp on Y-32 Xian</t>",
	{
		_this select 0 animatedoor ['Door_1_source', 0];
	},[],IL_Action_O_Priority,false,true,"",
	"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-6.5,-2.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target doorPhase 'Door_1_source' == 1) && (_target getVariable 'can_load')"
	];
...
if (_obj_main_type in IL_Supported_Vehicles_HURON) then
{
	...
	"(count(nearestObjects[ _target modelToWorld [0,-9,-4.5], IL_Supported_Cargo_Veh_HURON, IL_SDistL + IL_SDistL_Heli_offset]) > 0) && (abs(speed _target) <= IL_LU_Speed) && ((IL_Can_Inside && (driver _target == _this)) || (IL_Can_Inside && ('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-4.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target getVariable 'box_num' > _target getVariable 'slots_num') && (_target getVariable 'can_load') && (((getPos _target) select 2) <= IL_LU_Alt) && (_target doorPhase 'door_rear_source' == 1)"
	];
	...
	"(_this in (nearestObjects[ _target modelToWorld [0,-9,-4.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && ((_target emptyPositions 'cargo') > 0) && (abs(speed _target) <= IL_LU_Speed) && (((getPos _target) select 2) <= IL_LU_Alt) && (_target animationPhase 'Door_rear_source' > 0.43) && (_target getVariable 'usable_ramp')"
	];
	...
	_obj_main addAction [
	"<t color=""#0000ff"">Open cargo ramp on CH-67 Huron</t>",
	{
		_this select 0 animateDoor  ['Door_rear_source', 1];
	},[],IL_Action_O_Priority,false,true,"",
	"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-4.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target doorPhase 'Door_rear_source' == 0) && (_target getVariable 'can_load')"
	];

	_obj_main addAction [
	"<t color=""#0000ff"">Close cargo ramp on CH-67 Huron</t>",
	{
		_this select 0 animateDoor  ['Door_rear_source', 0];
	},[],IL_Action_O_Priority,false,true,"",
	"((driver _target == _this) || (('Turret' in (assignedVehicleRole _this)) && (vehicle _this == _target) && (_target getVariable 'can_copilot')) || ((_this in (nearestObjects[ _target modelToWorld [0,-9,-4.5], [], IL_SDistL + IL_SDistL_Heli_offset])) && (_target getVariable 'can_outside'))) && (_target doorPhase 'Door_rear_source' == 1) && (_target getVariable 'can_load')"
	];
